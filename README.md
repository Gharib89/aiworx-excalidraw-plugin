...
tools/
  ...
  layout.js         layout composition: stack/row/column, padded boxes, arrows that own the gap, fans that spread their landings, graphs laid out in layers by ELK and routed on the paths it returns (anchored on geometry.js bounds)
