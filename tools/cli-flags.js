 ...
 * sets straight from here. check.js, revise.js and library.js match their flags
 * by name, which keeps a flag added to a set below from silently aliasing one
 * already handled; `tests/cli-flags.js` is what proves those names still agree.
 *
...
export const LIBRARY_FLAGS = new Set(["json", "refresh", "stale", "download"]);
